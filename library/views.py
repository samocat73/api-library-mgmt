...
from library.serializers import BookSerializer, AuthorSerializer, BookDistributionSerializer
...
class BookDistributionViewSet(views.APIView):
    def post(self, request, *args, **kwargs):
        ...
        if serializer.is_valid(raise_exception=True):
            ...
            user = request.user
            distribution, created = BookDistribution.objects.get_or_create(user=user, book=book)
            message = {
